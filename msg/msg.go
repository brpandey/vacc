...
type ProofRequest struct {
	Proof         []byte `json:"proof"` // cryptographic proof generated by prover, verified with vkey
	PublicWitness []byte `json:"public_witness"` // allows prover to verify authenticity of proof
}
